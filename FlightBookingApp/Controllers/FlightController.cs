...
public class FlightController : Controller
{
    ...
    {
        String? isAdmin = HttpContext.Session.GetString("Email");
        if (isAdmin == null)
        {
            return RedirectToAction("Login", "Customer");
        }

        if (!isAdmin.ToLower().Equals("admin@admin.com"))
        {
            TempData["ErrorMessage"] = "Not authorized to add a flight";
            return RedirectToAction("Login", "Customer");
        }
    ...
    public IActionResult Edit(int id)
    {
        ...
        if (!isAdmin.ToLower().Equals("admin@admin.com"))
        {
            TempData["ErrorMessage"] = "Not authorized to edit a flight";
            return RedirectToAction("Login", "Customer");
        }
        ViewBag.StatusOptions = new List<string> { "Scheduled", "Delayed", "Cancelled" };
        try
    ...
    public IActionResult Cancel(int id)
    {
        ...
        if (!isAdmin.ToLower().Equals("admin@admin.com"))
        {
            TempData["ErrorMessage"] = "Not authorized to cancel a flight";
            return RedirectToAction("Login", "Customer");
        }
        try
        {
